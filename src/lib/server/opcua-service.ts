...
import { dataValueToNodeValue } from "./opcua-utils-server";
    ...
    try {
      ...
      for (const nodeId of nodeIds) {
        ...
        item.on("changed", (dataValue: DataValue) => {
          ...
          const monitoredDataValue = dataValue as MonitoredDataValue;
          monitoredDataValue.nodeId = nodeId;
          callback(monitoredDataValue);
        });
...
export { OPCUAService, SubscriptionCallbackRegistry };
