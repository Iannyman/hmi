...
/**
 * DataValue extended with nodeId for subscription callbacks.
 * The OPCUAService attaches the nodeId when relaying monitored item changes.
 */
export interface MonitoredDataValue extends DataValue {
  nodeId: string;
}

export type SubscriptionCallback = (dataValue: MonitoredDataValue) => void;
